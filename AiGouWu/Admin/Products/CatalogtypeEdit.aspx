<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CatalogtypeEdit.aspx.cs" Inherits="AiGouWu.Admin.Products.CatalogtypeEdit" %>
...
<body style="padding:10px;">
    ...
    <div class="navigation">
            <span class="back"><a href="CatalogtypeList.aspx">返回列表</a></span><b>您当前的位置：首页 &gt; 类型管理 &gt; 修改类型</b>
    </div>
    <div style="padding-bottom:10px;"></div>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      <tr>
        <th colspan="2" align="left">修改类型信息</th>
      </tr>
       <tr>
