<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="typeEdit.aspx.cs" Inherits="AiGouWu.Admin.Products.Edit" %>
...
<body style="padding:10px;">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      ...
      <tr>
       ...
       <tr>
         <td width="25%" align="right">是否锁定：</td>
         <td width="75%">
             <asp:CheckBox ID="cbisdel" runat="server" Text="是" />
         </td>
       </tr>
     </table>
