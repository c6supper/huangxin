...
<body style="padding:10px;">
    ...
    <div class="navigation"><span class="add"><a href="#"></a></span><b>您当前的位置：首页 &gt; 会员客户管理 &gt; 供货商列表</b></div>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      ...
      <tr>
        <td align="center"><asp:CheckBox ID="cb_id" CssClass="checkall"  runat="server" /></td>
                ...
                <td align="center"><span><a href="supplayedit.aspx?id=<%#Eval("id") %>">供货商验证</a></span></td>
      </tr>
      </ItemTemplate>
      <FooterTemplate>
      </table>
